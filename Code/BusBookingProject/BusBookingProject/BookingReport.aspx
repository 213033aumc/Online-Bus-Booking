...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:6%">
              ...
              <div id="ticket" runat="server" visible="false">
                <h1 style="font-weight: bold">Tiyara Booking</h1>
                <br />
                <br />

                <h2 style="font-weight: bold">PNR Details</h2>
                <div class="table-bordered">
                    <table class="table-striped" id="tbtPNR" runat="server" style="width: 100%; color: blue; font-size: large">
                        <tr>
                            <td style="font-weight: bold" class="auto-style1">PNR No</td>
                            <td class="auto-style1">
                                <asp:Label ID="lblTransactionNo" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold" class="auto-style1">Total Tickets</td>
                            <td class="auto-style1">
                                <asp:Label ID="lblTotalTickets" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold" class="auto-style1">Total Amount</td>
                            <td class="auto-style1">
                                <asp:Label ID="lblTotalAmount" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold" class="auto-style1">Bus Name</td>
                            <td class="auto-style1">
                ...
                <p style="text-align: center; " class="auto-style2">
                    <em>Thank you for Booking Ticket with us,have a pleasant journey!!!!
                </em>
                </p>
            </div>
    </div>
