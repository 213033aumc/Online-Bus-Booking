                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="Habib Bank Limited"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Bank Of Punjab"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Alfalah Bank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="UBL Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Allied Bank"></asp:ListItem>
                                <asp:ListItem>National Bank</asp:ListItem>
                            </asp:DropDownList>
